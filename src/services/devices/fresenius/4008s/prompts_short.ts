export const FRESENIUS_4008S_PROMPT = `
This is a medical device data extraction task for Fresenius 4008 S dialysis machines. 
...
7. GOAL IN (h:mm)
8. CLEARANCE (ml/min)
9. ARTERIAL PRESSURE (mmHg, from brighter glowing yellow LED)
10. VENOUS PRESSURE (mmHg, from brighter glowing yellow LED)
11. TMP (mmHg, from brighter glowing yellow LED)
12. CONDUCTIVITY (mS/cm, from glowing brighter yellow LED)
13. RATE(ml/min)
14. BOLUS(ml)
